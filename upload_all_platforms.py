"""
Velocity Finnish - Unified Social Media Upload Script
...
def get_latest_reel():
    ...
    return {
        ...
        "metadata": metadata,
        "category": metadata.get("category_finnish", "Finnish Learning"),
...
def generate_caption(phrases, category, platform="facebook"):
    ...
    if platform == "facebook":
        ...
        caption_lines = [
            f"🇫🇮 Learn Finnish with Velocity Finnish! 🇫🇮",
            f"",
            f"📚 Category: {category}",
            f"",
            f"🎯 Master Finnish one phrase at a time! Today's {category} lesson:",
            f""
        ]
        ...
        for i, phrase in enumerate(phrases[:5], 0):
            ...
            caption_lines.append(f"   📍 {phrase['finnish']}")
        ...
        caption_lines.extend([
            ...
            f"🔔 Follow for daily Finnish lessons!",
            f"",
...
def upload_to_all_platforms(video_path, caption, category):
    ...
    print("\n" + "="*80)
    print("🚀 VELOCITY FINNISH - MULTI-PLATFORM UPLOAD")
    print("="*80)
...
def main():
    ...
    print("\n" + "="*80)
    print("🇫🇮 VELOCITY FINNISH - AUTOMATED UPLOAD 🇫🇮")
    print("="*80)
